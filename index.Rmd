...
6) Knit that document, and then git commit and push to your personal GitHub. TESTING TO SEE IF THIS WORKS
...
dygraph(q_xts) %>%
  dyAxis("y", label = "Discharge (cfs)") %>% dyOptions(drawPoints = TRUE, pointSize = 2)
```


## Poudre Paragraph

testing this [hyperlink](https://www.nps.gov/places/cache-la-poudre-river-national-heritage-area.htm)
